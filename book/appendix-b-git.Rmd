...
```{r git-path, echo=FALSE, out.width="500px", fig.cap="Set the location of git"}
knitr::include_graphics("images/git_path.png")
```
...
2. Click **`Create RSA Key...`** and enter a passphrase
    ```{r git-options, echo=FALSE, out.width="500px", fig.cap="Global options"}
    knitr::include_graphics("images/git_options.png")
    ```
...
5. Click **`Add SSH key`**
    ```{r github-key, echo=FALSE, out.width="500px", fig.cap="Add SSH key"}

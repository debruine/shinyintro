...
if (is_html) {
  cat('![](images/shinyintro.png){style="float: right; width: 200px; height: 200px;" alt="Shinyintro Hex Logo"}')
}
```
...
* File paths: `r path("www/style.css")`
* R Packages: `r pkg("shinydashboard")`
* Functions: `r func("observeEvent", "input$button, {}")`
* Arguments: `r arg("width")`
* Strings: `r dt("Lisa")`
* Numbers: `r dt(100)`
* Logical values: `r dt(TRUE)`
* Other code: `x <- list(a = "Alligator", b = "Loki")`
* Glossary items: `r glossary("shiny")`
...
Find the application title. It is the first [argument](defs.html#argument) to the [function](defs.html#function) `r func("titlePanel")`. Change the `r arg("title")` to `r dt("My First App")`. Make sure the title is inside quotes and the whole quoted `r glossary("string")` is inside the parentheses. Save the file (`cmd-S` or `File > Save`).
...
## Further Reources {#resources-inputs}
...
In `r func("server")`, replace `r func("renderInfoBox")` with this:

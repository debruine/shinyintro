...
```{r settings-general, eval = F, echo=FALSE, out.width = "45%", fig.cap = "My RStudio General and Appearance settings"}
knitr::include_graphics(
...
```{r settings-code, eval = F, echo=FALSE, out.width = "45%", fig.cap = 'My RStudio Code settings'}
knitr::include_graphics(

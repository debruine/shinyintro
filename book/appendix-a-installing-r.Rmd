...
```{r settings-general, eval = TRUE, echo=FALSE, fig.width = "45%", fig.cap = "My RStudio General and Appearance settings"}
knitr::include_graphics(
  c('images/rstudio_settings_general.png', 
    'images/rstudio_settings_appearance.png'))
```

You may also want to change the settings in the Code tab. I prefer two spaces instead of tabs for my code and I like to be able to see the `r glossary("whitepspace")` characters. But these are all a matter of personal preference.

```{r settings-code, eval = TRUE, echo=FALSE, fig.width = "45%", fig.cap = 'My RStudio Code settings'}
knitr::include_graphics(

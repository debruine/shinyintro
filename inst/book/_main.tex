...
You can create the UI using renderUI() to return HTML created using the input functions we learned about in Chapter~\ref{inputs}, the \protect\hyperlink{tags}{tag functions}, or HTML that you write yourself (as an argument to HTML()).
...
Add outputs and appropriate render functions to show a plot and the data from the pets questionnaire you made for the exercise in Chapter~\ref{inputs}.
...
##               ID: 14uiUM2BxMO2MaYEA79NHFwsK2GRaTLEp5l_WQ2b85pc
##           Locale: en_US

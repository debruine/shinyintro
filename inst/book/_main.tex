...
\label{fig:radiotables-app}RadioTables Demo App. You can also access this app with \texttt{shinyintro::app("radiotables")}or view it in a separate tab with the \href{https://shiny.psy.gla.ac.uk/debruine/radiotables/}{showcase interface}.
...
##   expired OAuth token.
## * API keys are not supported by this API. Expected OAuth2
##   access token or other authentication credentials that
##   assert a principal. See
...
##               ID: 1bwIuzO7VBUKUSPkCr4oabj1fW1dBC0_dVRHJksYyx9g
##           Locale: en_US

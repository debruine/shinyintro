...
\NormalTok{mydata }\OtherTok{\textless{}{-}} \FunctionTok{reactive}\NormalTok{(\{}
  \ControlFlowTok{if}\NormalTok{ (input}\SpecialCharTok{$}\NormalTok{dataset }\SpecialCharTok{==} \StringTok{"mtcars"}\NormalTok{) \{ mtcars \} }\ControlFlowTok{else}\NormalTok{ \{ sleep \}}
\NormalTok{\})}
...
\begin{Highlighting}[]
\FunctionTok{observe}\NormalTok{(\{}
\NormalTok{  full\_data }\OtherTok{\textless{}{-}} \ControlFlowTok{if}\NormalTok{ (input}\SpecialCharTok{$}\NormalTok{dataset }\SpecialCharTok{==} \StringTok{"mtcars"}\NormalTok{) \{ mtcars \} }\ControlFlowTok{else}\NormalTok{ \{ sleep \}}
...
\begin{Highlighting}[]
\NormalTok{mydata }\OtherTok{\textless{}{-}} \FunctionTok{reactive}\NormalTok{(\{}
\NormalTok{  d }\OtherTok{\textless{}{-}} \ControlFlowTok{if}\NormalTok{ (input}\SpecialCharTok{$}\NormalTok{dataset }\SpecialCharTok{==} \StringTok{"mtcars"}\NormalTok{) \{ mtcars \} }\ControlFlowTok{else}\NormalTok{ \{ sleep \}}
...
\NormalTok{  \},}
  \AttributeTok{content =} \ControlFlowTok{function}\NormalTok{(file) \{}
\NormalTok{    rmarkdown}\SpecialCharTok{::}\FunctionTok{render}\NormalTok{(}\StringTok{"reports/pet\_report.Rmd"}\NormalTok{,}
...
\NormalTok{  \},}
  \AttributeTok{content =} \ControlFlowTok{function}\NormalTok{(file) \{}
\NormalTok{    rmarkdown}\SpecialCharTok{::}\FunctionTok{render}\NormalTok{(}\StringTok{"reports/food\_report.Rmd"}\NormalTok{,}
                      \AttributeTok{output\_file =}\NormalTok{ file,}
                      \AttributeTok{intermediates\_dir =} \FunctionTok{tempdir}\NormalTok{())}
\NormalTok{  \}}
\NormalTok{)}
